...
type ModalContent = 'about' | 'team' | 'careers' | 'privacy' | 'terms' | 'cookies' | null;
    ...
    switch (type) {
      ...
      case 'team':
        return {
          ...
          content: 'Somos un equipo multidisciplinario de periodistas, desarrolladores y diseñadores apasionados por la innovación en medios digitales. Trabajamos día a día para traerte las mejores noticias con la mejor experiencia de usuario posible.'
        };
      case 'careers':
        return {
          title: 'Carreras',
          content: '¿Te apasiona el periodismo digital y la tecnología? Estamos siempre buscando talento para unirse a nuestro equipo. Envía tu CV a careers@scoopnewspaper.com y cuéntanos por qué quieres formar parte de nuestra revolución digital.'
        };
      case 'privacy':
        return {
          title: t.privacy,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 text-xs">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button onClick={() => openModal('team')} className="text-gray-400 hover:text-blue-400 transition-colors">
                Equipo
              </button>
              <button onClick={() => openModal('careers')} className="text-gray-400 hover:text-blue-400 transition-colors">
                Carreras
              </button>
